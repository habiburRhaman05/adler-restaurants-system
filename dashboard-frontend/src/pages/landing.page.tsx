        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Stats strip */}
              <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-black/[0.06] pt-8">
                {stats.map((s) => (
                  <div key={s.label}>
                    <p className="text-2xl md:text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">
                      {s.value}
                    </p>
                    <p className="mt-1 text-xs md:text-sm font-medium text-[#64748B]">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
